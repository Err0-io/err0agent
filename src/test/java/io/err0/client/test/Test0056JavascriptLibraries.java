...
public class Test0056JavascriptLibraries {
    @Test
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0056/01";
            final String assertDir = "src/test/testdata/0056/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0056/02";
        ...
        // pass #3 - insert
        {
            ...
            final String sourceDir = "src/test/testdata/0056/03";
            final String assertDir = "src/test/testdata/0056/03-assert";
