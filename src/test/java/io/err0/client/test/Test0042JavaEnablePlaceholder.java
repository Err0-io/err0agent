...
public class Test0042JavaEnablePlaceholder {
    @Test
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0042/01";
            final String assertDir = "src/test/testdata/0042/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0042/02";
        ...
        // pass #3 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0042/03";
            final String assertDir = "src/test/testdata/0042/03-assert";
