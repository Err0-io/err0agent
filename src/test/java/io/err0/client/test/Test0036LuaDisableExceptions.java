...
public class Test0036LuaDisableExceptions {
    @Test
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0036/01";
            final String assertDir = "src/test/testdata/0036/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0036/02";
