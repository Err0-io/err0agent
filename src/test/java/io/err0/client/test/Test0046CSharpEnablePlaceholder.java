...
public class Test0046CSharpEnablePlaceholder {
    @Test
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0046/01";
            final String assertDir = "src/test/testdata/0046/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0046/02";
            ...
            assertEquals("PLACEHOLDER", previousState.metaDataStorage.get(5L).metaData.get("type").getAsString());
            assertEquals("LOG_OUTPUT", previousState.metaDataStorage.get(2L).metaData.get("type").getAsString());
            assertEquals("EXCEPTION_THROW", previousState.metaDataStorage.get(9L).metaData.get("type").getAsString());
        }
    }
}
