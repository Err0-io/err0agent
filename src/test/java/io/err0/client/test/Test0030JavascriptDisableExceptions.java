...
public class Test0030JavascriptDisableExceptions {
    @Test
    public void t0001InjectErrorCodes() {

        final String sourceDir = "src/test/testdata/0030/01";
        final String assertDir = "src/test/testdata/0030/01-assert";
