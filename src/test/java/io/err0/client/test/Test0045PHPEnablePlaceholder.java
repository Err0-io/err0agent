...
public class Test0045PHPEnablePlaceholder {
    @Test
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0045/01";
            final String assertDir = "src/test/testdata/0045/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0045/02";
            ...
            assertEquals("PLACEHOLDER", previousState.metaDataStorage.get(14L).metaData.get("type").getAsString());
            assertEquals("LOG_OUTPUT", previousState.metaDataStorage.get(1L).metaData.get("type").getAsString());
            assertEquals("EXCEPTION_THROW", previousState.metaDataStorage.get(4L).metaData.get("type").getAsString());
        }
    }
}
