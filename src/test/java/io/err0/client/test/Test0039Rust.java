...
public class Test0039Rust {
    ...
    public void t0001InjectErrorCodes() {
        ...
        // pass #1 - scan and analyse
        {
            ...
            final String sourceDir = "src/test/testdata/0039/01";
            final String assertDir = "src/test/testdata/0039/01-assert";
        ...
        // pass #2 - scan and report (no changes)
        {
            ...
            final String sourceDir = "src/test/testdata/0039/02";
