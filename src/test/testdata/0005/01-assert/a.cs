...
namespace io.err0.testdata {
    ...
    public class A {
        ...
        public void ProblemMethod(string param = "default") {
            throw new Exception("[E-6] Error in program.");
        }
#else
        [Annotation(val="2")]
        public void ProblemMethod(string param = "default") {
            throw new Exception("[E-7] Error in program.");
        }
#endif
    ...
    #region Your region starts here
        ...
        public static ReturnValue MethodDeclaredAsLambdaExpression(this ReturnValue input)
            => input.GetReturnValue() ?? throw new Exception("[E-8] A Lambda Expression");
        ...
        {
            throw new Exception("[E-9] An error.");
        }
